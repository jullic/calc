...
var calc = function calc() {
  ...
  calculator.addEventListener('click', function (e) {
    ...
    if (e.target.getAttribute('data-oper')) {
      var checkOperator = function checkOperator() {
        if (checkSign === '+' || resultValue === 0) {
          if (resultValue && currentValue !== '') {
            ...
            if (resCont && curCont) {
              ...
              console.log(currentValue);
              var length = resCont.length <= curCont.length ? resCont.length : curCont.length;
        ...
        if (checkSign === '-' || resultValue === 0) {
          if (resultValue && currentValue !== '') {
            ...
            if (resCont && curCont) {
              ...
              var _length = resCont.length <= curCont.length ? resCont.length : curCont.length;
            ...
            resultValue = (resultValue - parseFloat(currentValue)) / _degree;
          } else if (currentValue !== '') {
            resultValue = parseFloat(currentValue);
          } else {
            resultValue = resultValue;
        ...
        if (checkSign === '*' || resultValue === 0) {
          if (resultValue && currentValue !== '') {
            ...
            if (resCont && curCont) {
              ...
              var _length2 = resCont.length <= curCont.length ? resCont.length : curCont.length;
              ...
              console.log(_degree2);
              console.log(resultValue, currentValue);
            }

            resultValue = resultValue * parseFloat(currentValue) / _degree2;
          } else if (currentValue !== '') {
            resultValue = parseFloat(currentValue);
          } else {
            resultValue = resultValue;
        ...
        if (checkSign === '/' || resultValue === 0) {
          if (resultValue && currentValue !== '') {
            ...
            if (resCont && curCont) {
              ...
              var _length3 = resCont.length <= curCont.length ? resCont.length : curCont.length;
              ...
              for (var _i8 = 0; _i8 < _length3; _i8++) {
                currentValue = currentValue * 10;
              }

              console.log(_degree3);
              console.log(resultValue, currentValue);
            }
      ...
      var _chars = expression.split('');

      if (_chars[_chars.length - 1] === '+' || _chars[_chars.length - 1] === '-' || _chars[_chars.length - 1] === '*' || _chars[_chars.length - 1] === '/') {
        _chars.pop();

        expression = _chars.join('');
      }
      ...
      var checkSign = expression.replace(/[\.\d]/g, '').split('');
      ...
      checkOperator(); // resultValue = eval(expression);
    ...
    function maxLength() {
      if ((resultValue + '').length > 16) {
        var resArr = (resultValue + '').split('');

        for (var _i9 = resArr.length - 1; _i9 > 15; _i9--) {
          resArr.pop();
        }
